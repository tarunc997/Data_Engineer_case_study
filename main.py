...
from project_files.utils import read_yaml
from project_files.analysis import Analysis 
...
if __name__ == "__main__":
    ...
    extract.extract_zip_files(zip_path.get('Data'))

    analysis = Analysis(spark, config)
    # 1. Find the number of crashes (accidents) in which number of males killed are greater than 2?
    print(
        "1. Result:",
        analysis.count_male_accidents(output_file_paths.get(1), file_format.get("Output")),
    )

    # 2. How many two-wheelers are booked for crashes?
    print(
        "2. Result:",
        analysis.count_2_wheeler_accidents(
    ...
    print(
        "3. Result:",
        analysis.top_5_vehicle_makes_for_fatal_crashes_without_airbags(
    ...
    print(
        "4. Result:",
        analysis.count_hit_and_run_with_valid_licenses(
    ...
    print(
        "5. Result:",
        analysis.get_state_with_no_female_accident(
    ...
    print(
        "6. Result:",
        analysis.get_top_vehicle_contributing_to_injuries(
    ...
    print("7. Result:")
    analysis.get_top_ethnic_group_crash_for_each_body_style(
    ...
    print(
        "8. Result:",
        analysis.get_top_5_zip_codes_with_alcohols_as_cf_for_crash(
    ...
    print(
        "9. Result:",
        analysis.get_crash_ids_with_no_damage(
    ...
    print(
        "10. Result:",
        analysis.get_top_5_vehicle_brands(
